...
import {
  RemoveParticipantDialogDidTag,
  RemoveParticipantDialogGroupNameTag,
  RemoveParticipantDialogPlugin,
...
export default function plugin(pluginTags: TagList): RemoveParticipantDialogPlugin {
  ...
  return {
    reducer: () => ({}),
    render: (_, renderProps: DialogProps) => (
      <RemoveParticipantDialogContainer {...renderProps} did={did} groupName={groupName} />
    ),
