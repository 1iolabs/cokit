...
export function ChatListViewContainer(props: ChatListViewContainerProps) {
  ...
  const selectedChat = selectedChatId !== undefined ? chats.find((c) => c.id === selectedChatId) : undefined;
  ...
  const pluginId = priorityPlugin ?? (selectedChatId !== undefined ? loadedChats.get(selectedChatId) : undefined);
