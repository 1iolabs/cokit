...
import { AddParticipantDialogActionType, AddParticipantDialogChangeDidAction, AddParticipantDialogSaveAction } from "../actions/index.js";
...
export function AddParticipantsDialogContainer(props: DialogProps) {
    ...
    const onChangeParticipantId = (did: string) => dispatch<AddParticipantDialogChangeDidAction>({
        payload: { did },
