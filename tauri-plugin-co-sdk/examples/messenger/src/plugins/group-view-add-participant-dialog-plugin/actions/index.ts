...
export interface AddParticipantDialogChangeDidAction
  extends PayloadAction<
    AddParticipantDialogActionType.ChangeDid,
    {
      readonly did: string;
    }
  > {}

export interface AddParticipantDialogSaveAction
  extends PluginPublicAction<AddParticipantDialogActionType.Save>,
    PayloadAction<
      AddParticipantDialogActionType.Save,
      {
        readonly did: string;
      }
    > {}
