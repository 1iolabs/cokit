...
pub extern "C" fn storage_block_get(cid: *const u8, cid_size: u32, buffer: *mut u8, buffer_size: u32) -> u32 {
	panic!("only available for target_arch = \"wasm32\"");
}

#[cfg(not(target_arch = "wasm32"))]
pub extern "C" fn storage_block_set(cid: *const u8, cid_size: u32, buffer: *const u8, buffer_size: u32) -> u32 {
	panic!("only available for target_arch = \"wasm32\"");
}

#[cfg(not(target_arch = "wasm32"))]
pub extern "C" fn state_cid_read(buffer: *mut u8, buffer_size: u32) -> u32 {
	panic!("only available for target_arch = \"wasm32\"");
}

#[cfg(not(target_arch = "wasm32"))]
pub extern "C" fn state_cid_write(buffer: *const u8, buffer_size: u32) -> u32 {
	panic!("only available for target_arch = \"wasm32\"");
}

#[cfg(not(target_arch = "wasm32"))]
pub extern "C" fn event_cid_read(buffer: *mut u8, buffer_size: u32) -> u32 {
	panic!("only available for target_arch = \"wasm32\"");
}
