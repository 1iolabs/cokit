...
use libp2p::core::upgrade::{write_length_prefixed, read_length_prefixed};
...
impl Codec
{
    ...
    pub async fn send_message<S: AsyncWrite + Unpin>(&self, socket: &mut S, Message::Message(data): Message) -> Result<(), Error> {
