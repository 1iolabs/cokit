...
use futures::{future::BoxFuture, FutureExt, AsyncWriteExt};
use libp2p::{core::UpgradeInfo, InboundUpgrade, OutboundUpgrade, StreamProtocol, Stream};

use super::{codec, message::Message};

pub const PROTOCOL_NAME: StreamProtocol = StreamProtocol::new("/didcomm/2");
