...
A [core](../reference/core.md) is not restricted to DAG-CBOR and may use any given structure.
...
## Partial Data
As all data is represented as a graph, more precisely as a DAG (directed acyclic graph).
