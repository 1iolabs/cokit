...
You'll find some handy best practices and we'll also hand you some do's and don'ts to ease the start of development with CO-kit.
...
- Audience: Developers using CO-kit to build Apps
