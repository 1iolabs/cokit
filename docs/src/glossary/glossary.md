...
## Consensus
In CO-kit, consensus refers to the protocols ensuring that multiple peers agree on a shared state or actions – even in the presence of unreliable networks or malicious actors.
...
The recommended serialization format (also used throughout CO-kit) is [DAG-CBOR](../glossary/glossary.md#dag-cbor), which is a subset of [CBOR](../glossary/glossary.md#cbor) with links to [CIDs](../glossary/glossary.md#cid).  
...
For CO-kit, WASM is a mechanism to compile and execute schema logic.
